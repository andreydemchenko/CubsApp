...
import ru.turbopro.cubsapp.data.utils.ShoeColors
import ru.turbopro.cubsapp.data.utils.ShoeSizes
import ru.turbopro.cubsapp.data.utils.StoreProductDataStatus
import ru.turbopro.cubsapp.databinding.FragmentAddEditProductBinding
import ru.turbopro.cubsapp.ui.AddProductViewErrors
import ru.turbopro.cubsapp.ui.MyOnFocusChangeListener
import ru.turbopro.cubsapp.viewModels.AddEditProductViewModel
...
class AddEditProductFragment : Fragment() {
	...
	private fun onAddProduct() {
		...
		val price = binding.proPriceEditText.text.toString().toIntOrNull()
		val mrp = binding.proMrpEditText.text.toString().toIntOrNull()
